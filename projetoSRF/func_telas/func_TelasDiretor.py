...
class Config_TelasDiretor(QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui.label_2.setText('Olá, Dir. Elpidio')
        ...
        #se os campos estiverem preechidos
            ...
            if result:
                ...
                if dados_turma is not None:
                    id_curso = dados_turma[1]  # Suponha que o ID do curso está na coluna de índice 2
                    id_periodo = dados_turma[2]  # Suponha que o ID do período está na coluna de índice 1
                    serie_turma = dados_turma[3]
                    ...
                    if dados_curso is not None and dados_periodo is not None:
                        nome_curso = dados_curso[1]  # Suponha que o nome do curso está na coluna de índice 1
                        turno_periodo = dados_periodo[1]  # Suponha que o nome do período está na coluna de índice 1

                        # Agora, você pode acessar os dados da turma, do curso e do período
                        print(f"ID da Turma: {id_turma}")
                        print(f"Série da Turma: {serie_turma}")
                        print(f"Nome do Curso: {nome_curso}")
                        print(f"Nome do Período: {turno_periodo}")
                        self.ui.lbl
                    else:
                        print("Nenhum resultado encontrado para o ID do Curso ou do Período.")
                else:
                    print("Nenhum resultado encontrado para o ID da Turma.")
            else:
