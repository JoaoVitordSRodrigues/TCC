...
class Config_TelasDiretor(QMainWindow):
    ...
    def cadastrarAluno(self):
        ...
        if resultado == "Cadastro Realizado com Sucesso!":
            ...
            # Limpe os campos e realize outras ações após o cadastro bem-sucedido
        else:
            QMessageBox.warning(self, "Erro no Cadastro", resultado)

            
            # Configure os estilos e mostre mensagens de erro conforme necessário
